            ...
            <form action="upload_post.php" method="POST" enctype="multipart/form-data">
                <div class="card">
                  <div class="card-header">
                    <h4><b>Add Content</b></h4>
                  </div>
                  <div class="card-body">
                    <b><label for="photo">Select Photo:</label></b>
                    ...
                    <b><label for="caption">Caption:</label></b>
                    <input type="text" name="caption" id="caption" required>


                    <br>
                    <br>
                    <center><input class="btn btn-success" type="submit" value="Upload"></center>
                  </div>
                </div>
            </form>
            <?php } ?>
